<x-app-layout>
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Gérez les spécialités disponibles pour les médecins.
                </p>
            </div>
            ...
            <a
                ...
                class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white
                       text-sm font-medium rounded-md hover:bg-indigo-700
    ...
    <div class="py-12">
        <div class="max-w-xl mx-auto mt-8 bg-white shadow rounded-lg overflow-hidden">
            <ul class="divide-y divide-gray-200">
                ...
                @empty
                    <li class="px-6 py-8 text-sm text-gray-500 text-center">
